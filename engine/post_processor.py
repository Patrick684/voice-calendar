...
class PostProcessor:
    ...
    BUILTIN_RULES: List[dict] = [
        ...
        # ---- 日历场景同音纠错（拼音匹配）----
        {"pattern": "这株", "replacement": "这周", "is_pinyin": True},
        {"pattern": "名天", "replacement": "明天", "is_pinyin": True},
        {"pattern": "后添", "replacement": "后天", "is_pinyin": True},
        {"pattern": "大后添", "replacement": "大后天", "is_pinyin": True},
        {"pattern": "今添", "replacement": "今天", "is_pinyin": True},
        {"pattern": "零晨", "replacement": "凌晨", "is_pinyin": True},
        {"pattern": "五岁", "replacement": "午睡", "is_pinyin": True},
        {"pattern": "五睡", "replacement": "午睡", "is_pinyin": True},
        {"pattern": "吃放", "replacement": "吃饭", "is_pinyin": True},
        {"pattern": "见身", "replacement": "健身", "is_pinyin": True},
        {"pattern": "开汇", "replacement": "开会", "is_pinyin": True},
        {"pattern": "汇抱", "replacement": "汇报", "is_pinyin": True},
        # ---- 数字/量词误识别 ----
